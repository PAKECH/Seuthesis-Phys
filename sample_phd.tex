\documentclass[phd]{config/seuthesix}
...
%\setlength{\textfloatsep}{10pt plus 2.0pt minus 2.0pt} % Space between floats and text
%\setlength{\floatsep}{12pt plus 2.0pt minus 2.0pt}     % Space between two floats
%\setlength{\intextsep}{10pt plus 2.0pt minus 2.0pt}    % Space above and below in-line floats
